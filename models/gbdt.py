...
def _feature_matrix(examples: list[ParsedExample]) -> np.ndarray:
...
class GbdtModel:
    ...
    def feature_importance(self) -> dict[str, float]:
        ...
        return dict(zip(FEATURE_NAMES, importances.tolist(), strict=True))


def fit(examples: list[ParsedExample], labels: list[str]) -> GbdtModel:
    ...
    return GbdtModel(booster=booster)
